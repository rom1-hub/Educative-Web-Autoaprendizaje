...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    function generated(verb,tense,subject){
      const registry=window.COQ_PATTERN_REGISTRY;
      if(registry&&typeof registry.generate==='function'){
        const pattern=resolvePattern(verb);
        if(pattern==='er-eler'||pattern==='yer'){
          const generated=registry.generate(pattern,baseVerb(verb),baseSubject(subject),tense);
          if(generated!=null)return generated;
        }
      }
      return elerForms(verb,tense,subject)??yerForms(verb,tense,subject);
    }
