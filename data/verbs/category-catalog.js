...
(function(){
  const categories=[
    ...
    {id:'regular-er',label:'Premier groupe normal',groupes:[1],familyIds:['er-regular'],subCategories:['NORMAL']},
    {id:'er-ger',label:'Premier groupe verbes en GER',groupes:[1],familyIds:['er-ger'],subCategories:['GER']},
    {id:'er-cer',label:'Premier groupe verbes en CER',groupes:[1],familyIds:['er-cer'],subCategories:['CER']},
    {id:'er-eler',label:'Premier groupe verbes en -ELER',groupes:[1],familyIds:['er-eler-double','er-eler-accent'],subCategories:['ELER']},
    {id:'er-eter',label:'Premier groupe verbes en -ETER',groupes:[1],familyIds:['er-eter-double','er-eter-accent','er-eter-orthographic'],subCategories:['ETER']},
    {id:'yer',label:'Premier groupe verbes en -YER',groupes:[1],familyIds:['yer-oyer-uyer','yer-ayer'],subCategories:['YER']},
    {id:'er-e-accent',label:'Premier groupe verbe en -E (È) + consonne + ER',groupes:[1],familyIds:['er-e-accent'],subCategories:['E_ACUTE_CONSONANT_ER']},
    {id:'groupe-2',label:'Deuxième groupe',groupes:[2],familyIds:['ir-regular-2'],subCategories:['IR_SECOND']},
