...
(function(){
  ...
  sourceKeys.forEach(key=>{
    ...
    if(!family)throw new Error(`Verbe sans famille canonique: ${key}`);
    const merged=normalizeLegacyLexicalData(key,{...raw,familyId:family.id,patternId:family.patternId,groupe:family.groupe});
