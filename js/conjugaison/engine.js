...
(function(){
  ...
  function generatedSimple(verb,tense,subject){const r=record(verb);if(!r||!R||typeof R.generate!=='function')return null;const pattern=r.patternId||r.pattern;const infinitif=r.infinitifBase||r.infinitif_base||r.infinitif;return R.generate(pattern,infinitif,P.baseSubject(subject),tense);}
