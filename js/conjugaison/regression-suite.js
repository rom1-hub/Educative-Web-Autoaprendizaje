...
(function(){
  ...
  function run(){
    ...
    const compounds=[
      ...
      ['partir','passé composé','vous (masculin pluriel)','êtes partis'],['partir','plus-que-parfait','elle (féminin singulier)','était partie'],
      ['partir','conditionnel passé','elle (féminin singulier)','serait partie'],['partir','futur antérieur','elles','seront parties'],
      ['faire','passé composé','je (masculin singulier)','ai fait']
    ];
    ...
    const pronominal=[
      ['se lever','passé composé','je (féminin singulier)','me suis levée'],
      ['se lever','plus-que-parfait','elle (féminin singulier)',"s'était levée"],
      ['se lever','conditionnel passé','ils','se seraient levés']
    ];
    ...
    if(presentation){
      const subjRows=presentation.normalizeRows([
        {subject:'je',answer:'parle'},{subject:'il/elle/on',answer:'parle'},{subject:'ils/elles',answer:'parlent'}
