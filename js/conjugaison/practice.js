...
(function(){
  ...
  function matchesAuxiliary(v,tense,auxiliary){if(!auxiliary||!compoundTenseSet.has(tense))return true;return !!(auxiliaryResolver&&typeof auxiliaryResolver.matches==='function'&&auxiliaryResolver.matches(getRecord(v)||{},tense,auxiliary,compoundTenses,constructionResolver));}
