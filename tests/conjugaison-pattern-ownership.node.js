...
assert(Object.keys(registry).length>0,'El registro de generación de patterns no debe estar vacío.');
...
Object.values(families).forEach(family=>{
  ...
  assert(Object.prototype.hasOwnProperty.call(registry,patternId),`El pattern ${patternId} debe tener implementación en el registro.`);
});
Object.keys(patterns).forEach(patternId=>{
  assert(Object.prototype.hasOwnProperty.call(registry,patternId),`El catálogo declara ${patternId} sin implementación en el registro.`);
});
